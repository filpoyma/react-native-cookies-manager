...
public class CookieManagerModule extends ReactContextBaseJavaModule {
    ...
    private CookieManager getCookieManager() throws Exception {
        try {
            ...
            if (cookieManager == null) {
                throw new Exception("Failed to get CookieManager instance");
            }
            cookieManager.setAcceptCookie(true);
            return cookieManager;
        } catch (Exception e) {
            throw new Exception("Failed to initialize CookieManager: " + e.getMessage(), e);
        }
    }
    ...
    private HttpCookie makeHTTPCookieObject(String url, ReadableMap cookie) throws Exception {
        ...
        String cookieValue = cookie.getString("value");

        if (isEmpty(cookieName) || isEmpty(cookieValue)) {
            throw new Exception("Cookie name and value are required");
        }

        HttpCookie cookieBuilder = new HttpCookie(cookieName, cookieValue);
